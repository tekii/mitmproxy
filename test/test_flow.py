...
class TestServerPlaybackState:
    def test_hash(self):
        s = flow.ServerPlaybackState(None, [], False, False, None, False, False)
        r = tutils.tflow()
        r2 = tutils.tflow()
    ...
    def test_headers(self):
        s = flow.ServerPlaybackState(["foo"], [], False, False, None, False, False)
        r = tutils.tflow_full()
        r.request.headers["foo"] = ["bar"]
    ...
    def test_ignore_params(self):
        s = flow.ServerPlaybackState(None, [], False, False, ["param1", "param2"], False, False)
        r = tutils.tflow_full()
    ...
    def test_ignore_content(self):
        ...
        s = flow.ServerPlaybackState(None, [], False, False, None, True, False)
        r = tutils.tflow_full()
        r2 = tutils.tflow_full()
        r.request.content = "foo"
        r2.request.content = "foo"
    ...
    def test_enable_scenarios(self):
        s = flow.ServerPlaybackState(None, [], False, False, None, False, True)
        r = tutils.tflow_full()
        r2 = tutils.tflow_full()
        assert s._hash(r) == s._hash(r2)
    ...
    def test_enable_scenarios_and_headers(self):
        s = flow.ServerPlaybackState(["foo"], [], False, False, None, False, True)
        r = tutils.tflow_full()
        r2 = tutils.tflow_full()
        assert s._hash(r) == s._hash(r2)
        r2.request.headers[flow.SCENARIO_KEY] = ["bar"]
    ...
    def test_load(self):
        ...
        s = flow.ServerPlaybackState(None, [r, r2], False, False, None, False, False)
        assert s.count() == 2
    ...
    def test_load_with_nopop(self):
        ...
        s = flow.ServerPlaybackState(None, [r, r2], False, True, None, False, False)
...
class TestFlowMaster:
    ...
    def test_client_playback(self):
        ...
        fm = flow.FlowMaster(None, s)
        assert not fm.start_server_playback(pb, False, [], False, False, None, False, False)
    ...
    def test_server_playback(self):
        ...
        fm.start_server_playback(pb, False, [], False, False, None, False, False)
        assert fm.do_server_playback(tutils.tflow())

        fm.start_server_playback(pb, False, [], True, False, None, False, False)
        r = tutils.tflow()
    ...
    def test_server_playback_scenario(self):
        ...
        fm = flow.FlowMaster(None, s)
        fm.refresh_server_playback = True
        fm.start_server_playback(pb, False, [], False, False, None, False, True)
        f2 = tutils.tflow()
    ...
    def test_server_playback_kill(self):
        ...
        fm = flow.FlowMaster(None, s)
        fm.refresh_server_playback = True
        fm.start_server_playback(pb, True, [], False, False, None, False, False)
